...
async fn get_filament_returns_200() {
    ...
    let (status, body) =
        common::request(&app, Method::GET, &format!("/api/v1/filament/{id}"), None).await;
