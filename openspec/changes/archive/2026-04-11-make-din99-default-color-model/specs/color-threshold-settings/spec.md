...
- **THEN** the Same, Close, and Ballpark fields SHALL show the hardcoded default values for the active algorithm (CIEDE2000: 10 / 20 / 35; OKLab: 0.10 / 0.20 / 0.35; DIN99d: 13 / 19 / 25)
...
- **WHEN** no threshold keys have been persisted and the Same level is active with DIN99d
- **THEN** the filter uses threshold 13.0
