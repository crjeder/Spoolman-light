# Spec: Spool Color Hex Label

## Purpose

Display the hex color code as a text label immediately after each color swatch in the spool detail view, so users can read the exact color value at a glance.
