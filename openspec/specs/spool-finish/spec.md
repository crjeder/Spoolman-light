...
Spools carry a surface finish classification (Matte / Standard / Gloss) describing how the filament scatters light. Finish is selectable in the add and edit forms, shown as a badge in the spool table, and used by `color-search-selector` to adjust the stored color before distance comparison.
## Requirements
