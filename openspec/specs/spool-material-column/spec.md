# Spec: Spool Material Column

## Purpose

Display the filament material abbreviation for each spool in the spool list table, and indicate when a material filter is active via the column header.
