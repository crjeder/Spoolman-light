# Capability: SpoolmanDB Filament Lookup

## Purpose

Allows users to search the SpoolmanDB public filament database and auto-fill filament and spool form fields from a selected entry. Data is fetched from the SpoolmanDB CDN and cached locally in browser localStorage to minimise network requests.
